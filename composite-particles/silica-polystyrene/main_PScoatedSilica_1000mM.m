...
vdata =  xlsread('NvdW_PScoatedSilica_1000mM.xlsx','1M');
L =vdata(:,1);
vdwr =vdata(:,2);
...
for i = 1:length(r)
    i
    [timestore,xstore,ystore,zstore,U_r,adsorption_particle] = fun_SiO2particle_2nmPS_1000mM(r(i),phi(i),D(i),vp(i));
 ...
 save('G:\My Drive\Tanwee Simulation Results\PS coated Silica\1000 mM\nststat10_N4e5_2nmPScoatedSilica_1000mM')
