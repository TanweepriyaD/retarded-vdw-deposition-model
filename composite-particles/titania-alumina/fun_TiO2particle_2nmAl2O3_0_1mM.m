function[timestore,xstore,ystore,zstore,U_r,adsorption_particle] = fun_TiO2particle_2nmAl2O3_0_1mM(r,phi,D,vp)
    ...
    while (n_particle < N)
        ...
        while (adsorption_flag==0)&(exit_flag==0)
            ...
            dist_z = z(i-1)- r + roughness;
             ...
             if (dist_z<=0.5e-9)
                 F_vdw_z = -1.984e-21*exp(-1.99*log(dist_z))*r;
             elseif (0.5e-9<dist_z)&&(dist_z<=0.7e-9)
                 F_vdw_z = -2.071e-21*exp(-1.988*log(dist_z))*r;
             elseif (0.7e-9<dist_z)&&(dist_z<=20e-9)
                 F_vdw_z = (interp1(L,vdwr,dist_z))*r;
             elseif(20e-9<dist_z)&&(dist_y<=25e-9)
                 F_vdw_z = -1.459e-25*exp(-2.502*log(dist_z))*r;
             elseif (25e-9<dist_z)&&(dist_z<=40e-9)
                 F_vdw_z = -3.34e-26*exp(-2.586*log(dist_z))*r;
             elseif (40e-9<dist_z)&&(dist_z<=50e-9)
                 F_vdw_z = -1.013e-26*exp(-2.656*log(dist_z))*r;
             elseif (50e-9<dist_z)&&(dist_z<=70e-9)
                 F_vdw_z = -1.997e-27*exp(-2.698*log(dist_z))*r;
             elseif (70e-9<dist_z)&&(dist_z<=102.1e-9)
                 F_vdw_z = -2.312e-27*exp(-2.745*log(dist_z))*r;
             elseif (102.1e-9<dist_z)&&(dist_z<=154.5e-9)
                 F_vdw_z = -1.07e-27*exp(-2.793*log(dist_z))*r;
             elseif (154.5e-9<dist_z)&&(dist_z<=250.6e-9)
                 F_vdw_z = -4.137e-27*exp(-2.853*log(dist_y))*r;
             elseif (250.6e-9<dist_z)&&(dist_z<=397.2e-9)
                 F_vdw_z = -8.009e-29*exp(-2.961*log(dist_z))*r;
             elseif (397.2e-9<dist_z)
                 F_vdw_z = -8.818e-30*exp(-3.111*log(dist_z))*r;
             end
             
             if (dist_y<=0.5e-9)
                 F_vdw_y = -1.302e-21*exp(-2.009*log(dist_y))*r;
             elseif (0.5e-9<dist_y)&&(dist_y<=0.7e-9)
                 F_vdw_y = -2.071e-21*exp(-1.988*log(dist_y))*r;    
             elseif (0.7e-9<dist_y)&&(dist_y<=20e-9)
                 F_vdw_y = (interp1(L,vdwr,dist_y))*r;
             elseif(20e-9<dist_y)&&(dist_y<=25e-9)
                 F_vdw_y = -1.459e-25*exp(-2.502*log(dist_y))*r;
             elseif (25e-9<dist_y)&&(dist_y<=40e-9)
                 F_vdw_y = -3.34e-26*exp(-2.586*log(dist_y))*r;
             elseif (40e-9<dist_y)&&(dist_y<=50e-9)
                 F_vdw_y = -1.013e-26*exp(-2.656*log(dist_y))*r;
             elseif (50e-9<dist_y)&&(dist_y<=70e-9)
                 F_vdw_y = -1.997e-27*exp(-2.698*log(dist_y))*r;
             elseif (70e-9<dist_y)&&(dist_y<=102.1e-9)
                 F_vdw_y = -2.312e-27*exp(-2.745*log(dist_y))*r;
             elseif (102.1e-9<dist_y)&&(dist_y<=154.5e-9)
                 F_vdw_y = -1.07e-27*exp(-2.793*log(dist_y))*r;
             elseif (154.5e-9<dist_y)&&(dist_y<=250.6e-9)
                 F_vdw_y = -4.137e-27*exp(-2.853*log(dist_y))*r;
             elseif (250.6e-9<dist_y)&&(dist_y<=397.2e-9)
                 F_vdw_y = -8.009e-29*exp(-2.961*log(dist_y))*r;
             elseif (397.2e-9<dist_y)
                 F_vdw_y = -8.818e-30*exp(-3.111*log(dist_y))*r;
             end
