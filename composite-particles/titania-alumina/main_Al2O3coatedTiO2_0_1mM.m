...
%% Change
salt = 0.0001;                                 % in M (mol/L) M to mM occurs inside the function
...
r_core = [1e-6 5e-7 2.5e-7 1e-7];       % core radius, m
...
for i = 1:length(r)
    ...
    [timestore,xstore,ystore,zstore,U_r,adsorption_particle] = fun_TiO2particle_2nmAl2O3_0_1mM(r(i),phi(i),D(i),vp(i));
...
save('G:\My Drive\PhD\deposition\simulation\results\simulation\Al2O3 coated TiO2\0.1mM\nststat10_N4e5_2nmAl2O3coated_0_1mM')
