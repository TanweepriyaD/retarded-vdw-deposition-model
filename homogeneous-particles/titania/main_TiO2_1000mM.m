...
global u Q kB h T mu rho height width Length roughness salt nstatmax dt r_coating N c
global zetap zetaw
...
for i = 1:length(r)
    i
    [timestore,xstore,ystore,zstore,U_r,adsorption_particle] = fun_TiO2particle_1000mM(r(i),phi(i),D(i),vp(i));
 ...
 save('G:\My Drive\PhD\deposition\simulation\results\simulation\TiO2\nststat10_N4e5_TiO2_1000mM')
