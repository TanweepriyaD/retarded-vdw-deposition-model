function[timestore,xstore,ystore,zstore,U_r,adsorption_particle] = fun_TiO2particle_1000mM(r,phi,D,vp)

global Q kB T mu  height width Length roughness nstatmax dt N c
global N_A e epsilon0 epsilon zetap zetaw
    ...
    while (n_particle < N)
        ...
        while (adsorption_flag==0)&(exit_flag==0)
            ...
            dist_z = z(i-1)- r + roughness;
                ...
                F_vdw_z =  -6.862e-22*dist_z^(-2.05)*r;
                F_vdw_y = -6.862e-22*dist_y^(-2.05)*r;
